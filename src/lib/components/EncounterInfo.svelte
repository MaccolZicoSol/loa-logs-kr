    ...
    <div data-tauri-drag-region class="flex justify-between">
        <div data-tauri-drag-region class="flex space-x-2">
            ...
            <div
                ...
                use:menuTooltip={{ content: `총 피해량 ${totalDamageDealt.toLocaleString()}` }}>
                <div class="flex-shrink-0" data-tauri-drag-region>총 피해량</div>
            ...
            <div class="flex space-x-1 tracking-tighter text-gray-400" use:menuTooltip={{ content: `총 DPS` }}>
                <div class="flex-shrink-0" data-tauri-drag-region>총 DPS</div>
                {#if $settings.meter.abbreviateHeader}
                    <div data-tauri-drag-region>
        ...
        {#if !$takingScreenshot}
            <div
                ...
                <button class="" on:click={openMostRecentEncounter}>
                    <div use:menuTooltip={{ content: "최근 로그 열기" }}>
                        <svg
                ...
                <button
                    ...
                    use:menuTooltip={{ content: !$paused ? "세션 정지" : "세션 재개" }}>
                    {#if !$paused}
                        <svg
                            class="size-5 fill-gray-400 hover:fill-gray-50"
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <button on:click={resetSession} use:menuTooltip={{ content: "세션 초기화" }}>
                    <svg
                        class="size-5 fill-gray-400 hover:fill-gray-50"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 96 960 960"
                ...
                <button use:menuTooltip={{ content: "수동 저장" }} on:click={saveSession}>
                    <svg
                        class="size-5 fill-gray-400 hover:fill-gray-50"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <button use:menuTooltip={{ content: "스크린샷 복사" }} on:click={screenshotFn}>
                    <svg
                        class="size-5 fill-gray-400 hover:fill-gray-50"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 -960 960 960"
                    ...
                    {#if dropdownOpen}
                        <div class="absolute -right-5 top-6 z-50 rounded-md bg-zinc-700 shadow-md">
                            <div class="flex flex-col space-y-px p-1 text-gray-400">
                                {#if $updateSettings.available}
                                    <button class="flex-shrink-0 hover:text-gray-50 text-nowrap" on:click={openUpdateWindow}>
                            ...
                            <button
                                ...
                                <button class="hover:text-gray-50" on:click={enableClickThrough}>
                                    <div class="flex space-x-1 text-nowrap">
                                        <svg
                                            class="size-5 fill-gray-400"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 -960 960 960"
                ...
                <button on:click={() => appWindow.hide()}>
                    <div use:menuTooltip={{ content: "창 최소화" }}>
                        <svg
                            class="size-5 fill-gray-400 hover:fill-gray-50"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
