...
<div class="flex flex-col space-y-4 divide-y-[1px]">
    <div class="mt-4 flex flex-col space-y-2 px-2">
        ...
        <SettingItem
            name="클래스 색상 표시"
            description="클래스 색상을 표시합니다. 바의 너비는 상대적인 피해량 비율을 나타냅니다."
        ...
        <SettingItem
            name="플레이어 파티 고정"
            description="파티 버프가 나눠질 때, 로컬 플레이어의 파티를 미터기 상단에 고정합니다."
        ...
        <SettingItem name="DPS" description="현재 초당 피해량을 표시합니다." bind:setting={$settings.meter.dps} />
        <SettingItem
            name="치명타 비율"
    ...
    <div class="pt-4">
        ...
        <div class="mt-4 flex flex-col space-y-2 px-2">
            ...
            <SettingItem
                name="서폿 시너지 %"
                description="서폿 시너지로 인해 증가된 피해량의 비율을 표시합니다."
    ...
    <div class="pt-4">
        ...
        <div class="mt-4 flex flex-col space-y-2 px-2">
            ...
            <SettingItem
                name="스킬 치명타 피해량"
                description="스킬의 치명타 피해량의 비율을 표시합니다."
