...
<div class="px relative top-0" id="buff-table">
    {#if identityStats.average}
        <div class="mt-4">
            <div class="mb-2 text-lg font-medium tracking-tight">아르카나 아이덴티티 통계</div>
            <div>
                총 드로우한 카드 수: <span class="font-medium">{totalDraws.toLocaleString()}</span>
            </div>
            <div>
                분당 드로우 수: <span class="font-medium"
